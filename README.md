...
`docs/artifacts/generated/demo-urls.md` is the full catalogue: every mode, which URLs are embedded in production, and the rest of the params. It is generated from the flow registry by `npm run demo:urls`, so never edit it by hand.
...
| `docs/artifacts/source/` | Background on the customers and their workflows |
