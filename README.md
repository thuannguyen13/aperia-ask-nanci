...
`docs/demo-urls.md` holds the same list and is regenerated by `npm run demo:urls`.
...
- `docs/demo-urls.md` is generated. Regenerate it with `npm run demo:urls` instead of editing it.
...
| `docs/demo-urls.md` | Generated list of every demo URL |
| `docs/demo-context/` | Background on the customers and their workflows |
