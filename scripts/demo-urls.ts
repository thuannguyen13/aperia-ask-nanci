 ...
 *
 * Run: `npm run demo:urls` (writes docs/demo-urls.md and prints the table).
...
writeFileSync("docs/demo-urls.md", out)
console.log(out)
console.error(
  `\n✓ wrote docs/demo-urls.md — ${entries.length} embeddable flows, ${layoutOnly.length} layout-only, ${noSlug.length} card-only.`,
)
