...
export const SCRIPTED_CONVERSATIONS: Record<string, ScriptedTurn[]> = {
  ...
  "Update my business name": [
    ...
    { role: "assistant", content: "I can help with that. Your business name is currently registered as \"Walker's Business Books LLC\".\n\nWhat would you like to change it to? If this is a legal entity name change, you may need to provide supporting documentation such as an updated business license." },
    { role: "user", content: "Walker Bistro & Events LLC" },
    { role: "assistant", content: "Got it — changing from \"Walker's Business Books LLC\" to \"Walker Bistro & Events LLC\". Is this a legal name change or just a DBA (doing business as) update?" },
