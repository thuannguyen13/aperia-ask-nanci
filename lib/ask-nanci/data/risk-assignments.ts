...
/** Who a queue belongs to. "Unassigned" is a real state here: most of them are. */
export type Analyst = "Teresa Walker" | "Marcus Bell" | "Unassigned"
...
export interface Assignment {
  ...
  short: string
  /**
   * The analyst who owns the queue. Not on the assignment table anywhere — it exists
   * so the dashboard's Analyst filter has something real to narrow by, rather than a
   * control that changes its own label and nothing else.
   */
  owner: Analyst
