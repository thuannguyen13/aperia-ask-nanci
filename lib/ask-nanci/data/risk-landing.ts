...
// Four quick-action chips below the chat input. `prompt` is what gets asked when clicked.
export const RISK_QUICK_ACTIONS: { label: string; icon: LucideIcon; iconCls: string; prompt: string }[] = [
  { label: "High Risk Merchants",     icon: Store,     iconCls: "bg-rose-100 text-rose-600 dark:bg-rose-900/30 dark:text-rose-400",       prompt: "Show me today's high risk merchants" },
