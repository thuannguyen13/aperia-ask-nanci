// AI chat responses for the Clover / business-owner persona.
// Each entry is matched by keyword(s) from the user's message.
// BE dev: replace findResponse (in mock-data.ts) + these entries with a real LLM call.
...
// Maps response id → the human-readable question title shown in history/search.
