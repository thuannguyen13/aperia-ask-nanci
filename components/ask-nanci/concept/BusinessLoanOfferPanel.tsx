...
import {
  LOAN_OFFERS, LOAN_APPLICANT, LOAN_LIST_INSIGHT, LOAN_REQUEST_REF, LOAN_SENT_TO, LOAN_SUBMITTED_TITLE, LOAN_SUCCESS_MESSAGE,
  type LoanOffer,
...
export function BusinessLoanOfferPanel() {
  ...
  return (
    <PanelShell>
      <PanelHeader
        title={selected ? "Business Loan Application" : "Best Small Business Loans of July 2026"}
        size="lg"
