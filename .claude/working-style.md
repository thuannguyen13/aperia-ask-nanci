...
Repo-specific habits. Read before a multi-step task, before staging anything, and before
...
data, not vagueness. Generate the checklist for them to react to — reacting beats authoring. Run a
drift audit before demos.
